...
import com.amazon.model.services.UpdateScheduleRecord;
...
public class UpdateScheduleResponse {
   ...
   * @return payload
  **/
  @ApiModelProperty(value = "Contains the `UpdateScheduleRecords` for which the error/warning has occurred.")
