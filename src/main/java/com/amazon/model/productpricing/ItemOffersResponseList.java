...
import com.amazon.model.productpricing.ItemOffersResponse;
 ...
 */
@ApiModel(description = "A list of `getItemOffers` batched responses.")
...
public class ItemOffersResponseList extends ArrayList<ItemOffersResponse> {
  ...
  public String toString() {
    ...
    sb.append("class ItemOffersResponseList {\n");
