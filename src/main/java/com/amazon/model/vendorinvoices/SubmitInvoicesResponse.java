...
import com.amazon.model.vendorinvoices.ErrorList;
import com.amazon.model.vendorinvoices.TransactionId;
 ...
 */
@ApiModel(description = "The response schema for the submitInvoices operation.")
...
public class SubmitInvoicesResponse {
   ...
   * @return payload
  **/
  @ApiModelProperty(value = "The response payload for the submitInvoices operation.")
