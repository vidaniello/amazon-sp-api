...
import com.amazon.model.fulfillmentoutbound.GetFulfillmentPreviewItemList;
import com.amazon.model.fulfillmentoutbound.ShippingSpeedCategoryList;
...
public class GetFulfillmentPreviewRequest {
  ...
  **/
  @ApiModelProperty(value = "When true, returns all fulfillment order previews both for COD and not for COD. Otherwise, returns only fulfillment order previews that are not for COD.")
  ...
  **/
  @ApiModelProperty(value = "When true, returns the ScheduledDeliveryInfo response object, which contains the available delivery windows for a Scheduled Delivery. The ScheduledDeliveryInfo response object can only be returned for fulfillment order previews with ShippingSpeedCategories = ScheduledDelivery.")
