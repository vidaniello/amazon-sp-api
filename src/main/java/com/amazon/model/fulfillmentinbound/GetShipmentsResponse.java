...
import com.amazon.model.fulfillmentinbound.GetShipmentsResult;
 ...
 */
@ApiModel(description = "The response schema for the getShipments operation.")
...
public class GetShipmentsResponse {
   ...
   * @return payload
  **/
  @ApiModelProperty(value = "The payload for the getShipments operation.")
