...
import com.amazon.model.fulfillmentinbound.GetShipmentItemsResult;
 ...
 */
@ApiModel(description = "The response schema for the getShipmentItems operation.")
...
public class GetShipmentItemsResponse {
   ...
   * @return payload
  **/
  @ApiModelProperty(value = "The payload for the getShipmentItems operation.")
