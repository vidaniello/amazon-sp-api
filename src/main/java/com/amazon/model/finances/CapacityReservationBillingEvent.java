 ...
 */
@ApiModel(description = "An event related to a capacity reservation billing charge.")
...
public class CapacityReservationBillingEvent {
  ...
  **/
  @ApiModelProperty(value = "Indicates the type of transaction. For example, FBA Inventory Fee")
  ...
  public CapacityReservationBillingEvent postedDate(String postedDate) {
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A short description of the capacity reservation billing event.")
  ...
  **/
  @ApiModelProperty(value = "The amount of the capacity reservation billing event.")
