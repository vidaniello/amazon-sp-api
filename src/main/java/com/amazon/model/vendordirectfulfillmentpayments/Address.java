...
public class Address {
  ...
  **/
   ...
   * @return city
  **/
  @ApiModelProperty(required = true, value = "The city where the person, business or institution is located.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The state or region where person, business or institution is located.")
   ...
   * @return postalCode
  **/
  @ApiModelProperty(required = true, value = "The postal code of that address. It conatins a series of letters or digits or both, sometimes including spaces or punctuation.")
