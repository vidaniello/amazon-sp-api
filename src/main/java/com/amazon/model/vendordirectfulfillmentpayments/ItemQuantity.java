...
public class ItemQuantity {
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Quantity of units available for a specific item.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Unit of measure for the available quantity.")
