...
public class TransactionReference {
  ...
  **/
  @ApiModelProperty(value = "GUID assigned by Buyer to identify this transaction. This value can be used with the Transaction Status API to return the status of this transaction.")
