...
package com.amazon.model.notifications;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-05-11T14:52:58.990+02:00")
public class EventBridgeResource {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the partner event source associated with the destination.")
   ...
   * @return region
  **/
  @ApiModelProperty(required = true, value = "The AWS region in which you receive the notifications. For AWS regions that are supported in Amazon EventBridge, see https://docs.aws.amazon.com/general/latest/gr/ev.html.")
