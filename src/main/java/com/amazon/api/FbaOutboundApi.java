...
import com.amazon.model.fulfillmentoutbound.CancelFulfillmentOrderResponse;
import com.amazon.model.fulfillmentoutbound.CreateFulfillmentOrderRequest;
import com.amazon.model.fulfillmentoutbound.CreateFulfillmentOrderResponse;
import com.amazon.model.fulfillmentoutbound.CreateFulfillmentReturnRequest;
import com.amazon.model.fulfillmentoutbound.CreateFulfillmentReturnResponse;
import com.amazon.model.fulfillmentoutbound.GetFeatureInventoryResponse;
import com.amazon.model.fulfillmentoutbound.GetFeatureSkuResponse;
import com.amazon.model.fulfillmentoutbound.GetFeaturesResponse;
import com.amazon.model.fulfillmentoutbound.GetFulfillmentOrderResponse;
import com.amazon.model.fulfillmentoutbound.GetFulfillmentPreviewRequest;
import com.amazon.model.fulfillmentoutbound.GetFulfillmentPreviewResponse;
import com.amazon.model.fulfillmentoutbound.GetPackageTrackingDetailsResponse;
import com.amazon.model.fulfillmentoutbound.ListAllFulfillmentOrdersResponse;
import com.amazon.model.fulfillmentoutbound.ListReturnReasonCodesResponse;
import org.threeten.bp.OffsetDateTime;
import com.amazon.model.fulfillmentoutbound.SubmitFulfillmentOrderStatusUpdateRequest;
import com.amazon.model.fulfillmentoutbound.SubmitFulfillmentOrderStatusUpdateResponse;
import com.amazon.model.fulfillmentoutbound.UpdateFulfillmentOrderRequest;
import com.amazon.model.fulfillmentoutbound.UpdateFulfillmentOrderResponse;
...
public class FbaOutboundApi {
    ...
    private com.squareup.okhttp.Call submitFulfillmentOrderStatusUpdateValidateBeforeCall(String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = submitFulfillmentOrderStatusUpdateCall(sellerFulfillmentOrderId, body, progressListener, progressRequestListener);
        return call;
    ...
    public com.squareup.okhttp.Call submitFulfillmentOrderStatusUpdateAsync(String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body, final ApiCallback<SubmitFulfillmentOrderStatusUpdateResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = submitFulfillmentOrderStatusUpdateValidateBeforeCall(sellerFulfillmentOrderId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SubmitFulfillmentOrderStatusUpdateResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
